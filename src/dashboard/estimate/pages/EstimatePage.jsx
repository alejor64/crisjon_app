  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col">
        ...
        <EstimateFilters estimatePrices={estimatedPricesInSS} setestimatePrices={setestimatePrices} setShowAllRows={setShowAllRows} prepareEstimatedPrices={prepareEstimatedPrices} />
            ...
            <div className="overflow-hidden">
              {
                ...
                ? <Table thList={thList} tdList={estimatePrices} rowsToShow={rowsToShow} route="estimate" showAllRows={showAllRows} />
